...
const Formulario = () => {
  ...
  const guardarDatos = async (e) =>{
    ...
    await axios.post(URI, {nombre: nombre, apellidoP: apellidoP, apellidoM: apellidoM, genero:genero,
        telefono:telefono, celular:celular,  escuela:escuela, trabajo:trabajo, 
...
<div class="input-container">
      ...
      <input className='input' value={nombre} onChange={(e) => setNombre(e.target.value)} type= 'text'/>
     </div>

     <div class="input-container">
      <label className='label'>Apellido Paterno:</label>
      <input className='input' value={apellidoP} onChange={(e) => setApellidoP(e.target.value)} type= 'text'/>
      </div>
      <div class="input-container">
      <label className='label'>Apellido Materno:</label>
      <input className='input' value={apellidoM} onChange={(e) => setApellidoM(e.target.value)} type= 'text'/>
      </div>
      ...
      <input  className='input' value={genero} onChange={(e) => setGenero(e.target.value)} type= 'text'/>
      </div>
